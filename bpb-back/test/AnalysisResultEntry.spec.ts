...
describe.skip("AnalysisResultEntry",() => {
    describe("asJSON",() => {
        it("Should return a valid JSON object with the expected properties",() => {
            var expected = '{"sub_id":"subid1","context":"method","start":1,"end":2,"hash":"245rr1","text":"void test() { }"}'
            var expectedJSON = JSON.parse(expected);
            var analysisResultEntry = new AnalysisResultEntry("subid1","method",1,2,"245rr1","void test() { }");
